 ...
 * @param c
 */
exports.trimRightChar = function (str, c) {
    if (!str)  return '';
    var stopWord = '.';
    if(str.indexOf(stopWord)==-1){
        return str;
    }
...
exports.decorateTime = function (seconds) {
...
exports.substring = function (source, length) {
    if (source) {
